...
<body>
   ...
   <span>
      <div class="headlines hl1" title="Author: <?= $app['info']['author'][1] . '&#013' . " " . $app['info']['license'][1] ?>">
   ...
   <row class="row">
      ...
      <column class="col-right">
         <iframe name="viewport" class="transitor" src="modules/canvas.php" frameborder="0" title="viewport" height="0" onLoad="{
