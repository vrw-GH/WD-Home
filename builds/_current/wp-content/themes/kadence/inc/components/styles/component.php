...
class Component implements Component_Interface, Templating_Component_Interface {
	...
	public function generate_header_css() {
		...
		$css->add_property( 'background', $this->render_color( kadence()->sub_option( 'header_popup_close_background', 'color' ) ) );
		...
		$css->add_property( 'background', $this->render_color( kadence()->sub_option( 'header_popup_close_background', 'hover' ) ) );
		// Header Button.
	...
	public function generate_base_css() {
		...
		$css->set_selector( '.primary-sidebar.widget-area .sidebar-inner-wrap a:not(.button)' );
		$css->add_property( 'color', $this->render_color( kadence()->sub_option( 'sidebar_link_colors', 'color' ) ) );
		$css->set_selector( '.primary-sidebar.widget-area .sidebar-inner-wrap a:not(.button):hover' );
		...
		$css->set_selector( '.site-footer .site-middle-footer-wrap .site-footer-row-container-inner a:not(.button)' );
		$css->add_property( 'color', $this->render_color( kadence()->sub_option( 'footer_middle_link_colors', 'color' ) ) );
		$css->set_selector( '.site-footer .site-middle-footer-wrap .site-footer-row-container-inner a:not(.button):hover' );
		...
		$css->set_selector( '.site-footer .site-top-footer-wrap .site-footer-row-container-inner a:not(.button)' );
		$css->add_property( 'color', $this->render_color( kadence()->sub_option( 'footer_top_link_colors', 'color' ) ) );
		$css->set_selector( '.site-footer .site-top-footer-wrap .site-footer-row-container-inner a:not(.button):hover' );
		...
		$css->set_selector( '.site-footer .site-bottom-footer-wrap .site-footer-row-container-inner a:not(.button)' );
		$css->add_property( 'color', $this->render_color( kadence()->sub_option( 'footer_bottom_link_colors', 'color' ) ) );
		$css->set_selector( '.site-footer .site-bottom-footer-wrap .site-footer-row-container-inner a:not(.button):hover' );
		...
		if ( class_exists( 'woocommerce' ) ) {
			...
			$css->start_media_query( $media_query['tablet'] );
			$css->set_selector( '.product-archive-title h1' );
			$css->add_property( 'font-size', $this->render_font_size( kadence()->option( 'product_archive_title_heading_font' ), 'tablet' ) );
			$css->add_property( 'line-height', $this->render_font_height( kadence()->option( 'product_archive_title_heading_font' ), 'tablet' ) );
			$css->add_property( 'letter-spacing', $this->render_font_spacing( kadence()->option( 'product_archive_title_heading_font' ), 'tablet' ) );
			$css->stop_media_query();
			$css->start_media_query( $media_query['mobile'] );
			$css->set_selector( '.product-archive-title h1' );
			$css->add_property( 'font-size', $this->render_font_size( kadence()->option( 'product_archive_title_heading_font' ), 'mobile' ) );
			$css->add_property( 'line-height', $this->render_font_height( kadence()->option( 'product_archive_title_heading_font' ), 'mobile' ) );
			$css->add_property( 'letter-spacing', $this->render_font_spacing( kadence()->option( 'product_archive_title_heading_font' ), 'mobile' ) );
			$css->stop_media_query();
		...
		foreach ( $all_post_types as $post_type_item ) {
			...
			if ( ! in_array( $post_type_name, $ignore_type, true ) ) {			
				if ( is_singular( $post_type_name ) ) {
					...
					$css->add_property( 'color', $this->render_color( kadence()->sub_option( $post_type_name . '_title_category_color', 'color' ) ) );
					$css->set_selector( '.' . $post_type_name . '-title .entry-taxonomies a:hover' );
					$css->add_property( 'color', $this->render_color( kadence()->sub_option( $post_type_name . '_title_category_color', 'hover' ) ) );
					$css->set_selector( '.' . $post_type_name . '-title .entry-taxonomies .category-style-pill a' );
					$css->add_property( 'background', $this->render_color( kadence()->sub_option( $post_type_name . '_title_category_color', 'color' ) ) );
					$css->set_selector( '.' . $post_type_name . '-title .entry-taxonomies .category-style-pill a:hover' );
					$css->add_property( 'background', $this->render_color( kadence()->sub_option( $post_type_name . '_title_category_color', 'hover' ) ) );
					$css->start_media_query( $media_query['tablet'] );
	...
	public function action_add_gutenberg_styles() {
		...
		wp_add_inline_style( 'wp-edit-blocks', trim( apply_filters( 'kadence_editor_dynamic_css', '' ) ) );
		// Enqueue Google Fonts.
		$google_fonts_url = $this->get_google_fonts_url();
		if ( ! empty( $google_fonts_url ) ) {
	...
	/**
	 * Connects theme styles to kadence block style so it loads in full size editing context.
	 * This is a workaround so dynamic css can be loaded in FSE mode.
	 */
	public function update_block_style_dependencies() {
		$wp_styles = wp_styles();
		$style     = $wp_styles->query( 'kadence-blocks-editor-css', 'registered' );
