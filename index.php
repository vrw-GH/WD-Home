...
$site = ["Wrights Desk", "wrightsdesk.com"];
?>
...
<body>
   ...
   <iframe name="siteView" src="docs/README.md" loading="lazy" title="siteView" srcdocxx="Loading..." srcdoc='<?= $readmeMD ?>' onload="this.removeAttribute('srcdocxx')"></iframe>
